import { PoolOptions, Database, OkPacket, ResultSetHeader, RowDataPacket } from "@warehouse/dbclient";
...
export type Rows = OkPacket | ResultSetHeader | RowDataPacket[] | RowDataPacket[][] | OkPacket[]
